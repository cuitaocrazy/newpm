...
import pymysql
# MySQL 目标连接：默认本地;迁生产时用 MYSQL_HOST/MYSQL_PORT/MYSQL_PWD 指向(经隧道的)生产库
mysql = pymysql.connect(host=os.environ.get('MYSQL_HOST', '127.0.0.1'),
                        port=int(os.environ.get('MYSQL_PORT', '3306')),
                        user='root', password=os.environ.get('MYSQL_PWD', 'password'),
