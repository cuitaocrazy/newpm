...
--
-- Table structure for table `pm_contract`
--
...
CREATE TABLE `pm_contract` (
  ...
  KEY `idx_create_time` (`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='合同管理表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pm_customer` (
  ...
  `industry` varchar(100) DEFAULT NULL COMMENT '所属行业(字典)',
  `region` varchar(100) DEFAULT NULL COMMENT '所属区域(字典:sys_yjqy)',
...
--
-- Table structure for table `pm_customer_contact`
--
...
CREATE TABLE `pm_customer_contact` (
  ...
  `contact_tag` varchar(100) NOT NULL COMMENT '联系人标签(字典)',
  `del_flag` char(1) DEFAULT '0' COMMENT '删除标志(0正常 1删除)',
  `create_by` varchar(64) DEFAULT NULL COMMENT '创建者',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_by` varchar(64) DEFAULT NULL COMMENT '更新者',
...
--
-- Table structure for table `pm_payment`
--
...
CREATE TABLE `pm_payment` (
  ...
  KEY `idx_create_time` (`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='款项表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `pm_payment_milestone`
--
...
CREATE TABLE `pm_payment_milestone` (
  ...
  KEY `idx_create_time` (`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='款项里程碑表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `pm_project_approval`
--
...
--
-- Table structure for table `pm_project_contract_rel`
--
...
CREATE TABLE `pm_project_contract_rel` (
  ...
  KEY `idx_create_time` (`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='项目合同关系表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `pm_project_member`
--
...
--
-- Table structure for table `pm_team_revenue_confirmation`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='团队收入确认表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_dept` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`dept_id`)
) ENGINE=InnoDB AUTO_INCREMENT=225 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='部门表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=205 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='字典数据表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=115 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='字典类型表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2057 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='菜单权限表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=768 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_user` (
  ...
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=251 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-01-30 13:56:58
