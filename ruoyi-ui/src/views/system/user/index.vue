  ...
  <div class="app-container">
          ...
          <el-col>
            <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
              <el-form-item label="登陆用户" prop="userName">
                <el-input v-model="queryParams.userName" placeholder="请输入登陆用户" clearable style="width: 240px" @keyup.enter="handleQuery" />
              </el-form-item>
            ...
            <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
              ...
              <el-table-column label="登陆用户" align="center" key="userName" prop="userName" v-if="columns.userName.visible" :show-overflow-tooltip="true" />
    ...
    <el-dialog :title="title" v-model="open" width="600px" append-to-body>
      <el-form :model="form" :rules="rules" ref="userRef" label-width="80px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item v-if="form.userId == undefined" label="登陆用户" prop="userName">
              <el-input v-model="form.userName" placeholder="请输入登陆用户" maxlength="30" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
const columns = ref<Record<string, TableShowColumns>>({
  ...
  userName: { label: '登陆用户', visible: true },
...
const data = reactive({
  ...
  rules: {
    userName: [{ required: true, message: "登陆用户不能为空", trigger: "blur" }, { min: 2, max: 20, message: "登陆用户长度必须介于 2 和 20 之间", trigger: "blur" }],
