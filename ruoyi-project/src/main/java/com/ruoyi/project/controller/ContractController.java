...
public class ContractController extends BaseController
{
     ...
     * 获取合同管理详细信息
     */
    @PreAuthorize("@ss.hasAnyPermi('project:contract:query,project:contract:add,project:contract:edit,project:contract:attachment,project:payment:query,project:payment:add,project:payment:edit')")
