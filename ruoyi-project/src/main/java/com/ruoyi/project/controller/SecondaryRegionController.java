...
public class SecondaryRegionController extends BaseController
{
     ...
     * 查询二级区域列表
     */
    @PreAuthorize("@ss.hasAnyPermi('project:secondaryRegion:list,project:project:list,project:project:edit,project:project:add,project:contract:list,project:contract:query,project:projectStageChange:list,revenue:company:list,revenue:team:list,project:review:list')")
    @GetMapping("/list")
